...
arr_move = ['up', 'down', 'left', 'right']
gambar_move = {}
for i in arr_move:
    filename = 'gambar_angka/arrow_'+ i +'.png'
    gambar_move[i] = pygame.image.load(filename)
...
def display_move(move):
    pos_move_image = (500, 500)
    screen.blit(gambar_move[move], pos_move_image)
